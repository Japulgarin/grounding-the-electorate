...
COPY = {
    'en': {
        ...
        'bodies':[
            ...
            'The same experiment ran in El Salvador 2024 (50,000 personas, Spanish and English) and Brazil 2026 (50,000 personas, Portuguese and English). El Salvador has a real result to compare with (Bukele 84.6%); Brazil votes in October 2026, so there the thesis tests how the model decides.',
    ...
    'es': {
        ...
        'bodies':[
            ...
            'El mismo experimento se hizo en El Salvador 2024 (50.000 personas, español e inglés) y en Brasil 2026 (50.000 personas, portugués e inglés). El Salvador tiene un resultado real con el que comparar (Bukele 84,6 %); Brasil vota en octubre de 2026, así que allí la tesis estudia cómo decide el modelo.',
    ...
    'pt': {
        ...
        'bodies':[
            ...
            'O mesmo experimento foi feito em El Salvador 2024 (50.000 personas, espanhol e inglês) e no Brasil 2026 (50.000 personas, português e inglês). El Salvador tem um resultado real para comparar (Bukele 84,6%); o Brasil vota em outubro de 2026, então ali a tese estuda como o modelo decide.',
    ...
    'de': {
        ...
        'bodies':[
            ...
            'Dasselbe Experiment lief in El Salvador 2024 (50.000 Personen, Spanisch und Englisch) und Brasilien 2026 (50.000 Personen, Portugiesisch und Englisch). Für El Salvador gibt es ein echtes Ergebnis zum Vergleich (Bukele 84,6 %); Brasilien wählt im Oktober 2026, dort untersucht die Arbeit, wie das Modell entscheidet.',
...
COPY['en']['findings'] = ('Richer personas create a far more diverse electorate. With demographics alone the model already varies by region (in El Salvador, in English, Bukele goes from 30% in Morazán to 99% in San Salvador), but it pushes each group to its typical side; '
...
COPY['es']['findings'] = ('Las personas más ricas crean un electorado mucho más diverso. Solo con datos demográficos el modelo ya varía por región (en El Salvador, en inglés, Bukele va del 30 % en Morazán al 99 % en San Salvador), pero empuja a cada grupo hacia su lado típico; '
...
COPY['pt']['findings'] = ('Personas mais ricas criam um eleitorado muito mais diverso. Só com dados demográficos o modelo já varia por região (em El Salvador, em inglês, Bukele vai de 30% em Morazán a 99% em San Salvador), mas empurra cada grupo para o seu lado típico; '
...
COPY['de']['findings'] = ('Reichere Personen erzeugen eine viel vielfältigere Wählerschaft. Schon mit demografischen Angaben variiert das Modell regional (El Salvador, Englisch: Bukele von 30 % in Morazán bis 99 % in San Salvador), drängt aber jede Gruppe auf ihre typische Seite; '
